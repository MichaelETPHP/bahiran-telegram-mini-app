...
<!-- For checkpoint task examples and patterns, see @C:/SVELT_APP/underMentenance/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/SVELT_APP/underMentenance/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/SVELT_APP/underMentenance/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/SVELT_APP/underMentenance/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
