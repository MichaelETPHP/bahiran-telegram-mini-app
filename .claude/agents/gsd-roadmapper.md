...
Reference full template: `C:/SVELT_APP/underMentenance/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/SVELT_APP/underMentenance/.claude/get-shit-done/templates/state.md`.
